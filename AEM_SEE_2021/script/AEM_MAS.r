...
# programa Muestreo Aleatorio Simple

# ejemplo de educacion 
# este programa selecciona una muestra
# pequeña (m.a.s.) estima la varianza para
# calcular tamaño de muestra
# selecciona por m.a.s. una muestra
# y estima (puntual y por intervalos)
# el promedio de calificaciones,
# el total de ingresos
# y la proporcion de alumnos que trabajan
...
tabla <- cbind(delta,n.prop,nn.prop)
tabla
...
nn1; nn2; nn3
# tomemos un tamaño de muestra n=800
